...
"nmap <silent> ;u :w<CR> :! bash -c 'grep -vi buildscale "%" ; grep -i buildscale "%" \| tail -r' \| urlview <CR> :<CR>
nmap <silent> ;u :w<CR> :! bash -c '{ urlextract.sh "%" ; terraform_registry_url_extract.sh "%"; } \| terraform_registry_url_to_https.sh \| lines_to_end.sh buildscale \| urlview' <CR> :<CR>
...
"    autocmd FileType vim              let b:comment_char = '"'
    ...
    " https://github.com/BuildScale/Python-DevOps-Tools repo which should be downloaded, run 'make' and add to $PATH
    ...
    " these tools are in the https://github.com/BuildScale/DevOps-Python-tools & DevOps-Scripts repos which should be downloaded, run 'make' and add to $PATH
