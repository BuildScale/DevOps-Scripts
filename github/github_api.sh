...
#  args: /user | jq .
#  args: /users/BuildScale/repos | jq .
#  args: /repos/BuildScale/DevOps-Scripts/actions/workflows | jq.
...
# Get the GitHub Actions workflows for a given repo:
    ...
    ${0##*/} /repos/BuildScale/DevOps-Scripts/actions/workflows
