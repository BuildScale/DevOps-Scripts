...
#  args: devops-scripts echo user={user} repo={repo} name={name} workflow_name={workflow} id={id}
#
...
eg.
    ${0##*/} devops-scripts echo user={user} repo={repo} name={name} workflow_name={workflow} id={id}
    ${0##*/} devops-scripts echo org={org}   repo={repo} name={name} workflow_name={workflow} id={id}
"
