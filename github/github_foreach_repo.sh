...
{owner}               => the user or organization that owns the repo eg. BuildScale or MyOrg, whichever owns the repo
{repo}                => the repo name without the owner prefix eg. DevOps-Scripts
