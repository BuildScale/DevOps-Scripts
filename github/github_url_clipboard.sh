...
Designed to quickly and easily copy link content into BuildScale/Knowledge-Base repo
eg. for BuildScale/SQL-scripts references to be easily copyable code blocks without having to follow links
