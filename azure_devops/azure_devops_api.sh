...
#
#  https://azure_devops.com/buildscale/bash-tools
#
...
# List a user or organization's Azure DevOps repos:
    ...
    ${0##*/} /buildscale/GitHub/_apis/git/repositories  | jq .
...
# List a user or organization's Azure DevOps Pipelines:
    ...
    ${0##*/} /buildscale/GitHub/_apis/pipelines | jq .
...
# Get a specific pipeline (has an href to the build yaml):
    ...
    ${0##*/} /buildscale/GitHub/_apis/pipelines/1 | jq .
