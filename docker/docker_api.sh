...
#  args: https://hub.docker.com/v2/repositories/buildscale/hbase/tags | jq .
#
...
# Get all the tags for a given repository called 'buildscale/hbase' on DockerHub's public registry:

    ${0##*/} https://hub.docker.com/v2/repositories/buildscale/hbase/tags
