...
See also:
  ...
  find_active_impalad.py - https://github.com/BuildScale/DevOps-Python-tools

  HAProxy Configs for Impala and many other technologies - https://github.com/BuildScale/HAProxy-configs
...
if [ -n "${IMPALA_HOST:-}" ]; then
    ...
    # or alternatively use HAProxy config for load balanced impala clusters - see https://github.com/BuildScale/HAProxy-configs
    impalad="$(
