...
# See also:
#
#   find_active_*.py - https://github.com/BuildScale/DevOps-Python-tools
#
#   HAProxy Configs for many Hadoop and other technologies - https://github.com/BuildScale/HAProxy-configs
#
