...
# Alpine / Wget:
#
#   wget -O- https://raw.githubusercontent.com/BuildScale/DevOps-Scripts/master/setup/bootstrap.sh | sh
#
# Curl:
#
#   curl https://raw.githubusercontent.com/BuildScale/DevOps-Scripts/master/setup/bootstrap.sh | sh

set -eu
[ -n "${DEBUG:-}" ] && set -x
srcdir="$(dirname "$0")"

repo="https://github.com/BuildScale/DevOps-Scripts"
