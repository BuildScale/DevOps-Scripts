...
#
#  https://travis.com/buildscale/bash-tools
#
...
# Get crons (repository slug must be url-encoded replacing slash with %2F):
    ...
    ${0##*/} /repo/BuildScale%2FDevOps-Scripts/crons
...
# Get repository settings:
    ...
    ${0##*/} /repo/BuildScale%2FDevOps-Scripts/settings
...
# List caches for a repository:
    ...
    ${0##*/} /repo/BuildScale%2FDevOps-Scripts/caches
...
# List environment variables for a repository:
    ...
    ${0##*/} /repo/BuildScale%2FDevOps-Scripts/env_vars
"
