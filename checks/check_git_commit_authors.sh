...
check_duplicate_email_prefixes(){
    ...
    # email prefixes normalize hari.sekhon => buildscale since email accounts like gmail treat them the same, so remember duplicates for buildscale may include hari.sekhon
