...
# SYSTEM_TASKDEFINITIONSURI=https://dev.azure.com/buildscale/
# SYSTEM_TEAMFOUNDATIONCOLLECTIONURI=https://dev.azure.com/buildscale/
# SYSTEM_TEAMFOUNDATIONSERVERURI=https://dev.azure.com/buildscale/
# TF_BUILD=True
#
is_azure_devops(){
    if is_tfs_ci; then
