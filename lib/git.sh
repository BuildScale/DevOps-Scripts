...
# shouldn't need to use this any more, git_check_branches_upstream.py from DevOps Python Tools repo has a --fix flag which will do this for all branches if they have no upstream set - https://github.com/BuildScale/DevOps-Python-tools
set_upstream(){
...
azure_to_git_url(){
    ...
    #
    #   git@ssh.dev.azure.com:v3/buildscale/GitHub/DevOps-Scripts
    #   https://dev.azure.com/buildscale/GitHub/_git/DevOps-Scripts
    #
