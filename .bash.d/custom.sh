...
export GITHUB_USER=BuildScale
export TRAVIS_USER="BuildScale"
export BUILDKITE_ORGANIZATION=hari-sekhon
export SEMAPHORE_CI_ORGANIZATION=buildscale
...
alias pll="travis_last_log.py BuildScale/nagios-plugins"
