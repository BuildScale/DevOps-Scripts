...
#  args: github/BuildScale/DevOps-Scripts haritest=stuff
#
...
Examples:
    ...
    ${0##*/} github/BuildScale/DevOps-Scripts AWS_ACCESS_KEY_ID=AKIA...

    echo AWS_ACCESS_KEY_ID=AKIA... | ${0##*/} github/BuildScale/DevOps-Scripts


    Loads both AWS_ACCESS_KEY_ID and AWS_SECRET_ACCESS_KEY via stdin:

        aws_csv_creds.sh credentials_exported.csv | ${0##*/} github/BuildScale/DevOps-Scripts
"
